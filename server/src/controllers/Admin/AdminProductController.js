...
//         delete productDetails.expiryDate; // remove invalid date
//       } else {
//         productDetails.expiryDate = expiry; // valid date object
//       }
//     } else {
//       delete productDetails.expiryDate; // no date provided, remove field
//     }

//     if (productDetails.manufactureDate) {
//       const mfg = new Date(productDetails.manufactureDate);
//       if (isNaN(mfg.getTime())) {
//         delete productDetails.manufactureDate; // invalid date — remove the field
//       } else {
//         productDetails.manufactureDate = mfg; // valid date
//       }
//     } else {
//       delete productDetails.manufactureDate; // empty or missing — remove the field
//     }

//     // Validate quantityPerPackage
...
//       if (isNaN(qty) || qty < 1) {
//         // Invalid number, remove the field instead of throwing error
//         delete productDetails.quantityPerPackage;
//       } else {
//         productDetails.quantityPerPackage = qty;
//       }
//     } else {
//       // If empty or undefined, remove the field as well
//       delete productDetails.quantityPerPackage;
//     }
...
//         // Invalid value — remove the field instead of throwing error
...
//     // Remove stock from productDetails to avoid saving it twice
//     const initialStock = parseInt(productDetails.stock, 10) || 0;

//     // Set inStock to false if stock is 0 or less
//     if (initialStock <= 0) {
